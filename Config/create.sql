...
CREATE TABLE IF NOT EXISTS `documents_sharing`
(
...
CREATE TABLE IF NOT EXISTS `documents_sharing_document`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `documents_sharing_groupe`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `documents_sharing_i18n`
(
    `id` INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS `documents_sharing_document_i18n`
(
    `id` INTEGER NOT NULL,
    `locale` VARCHAR(5) DEFAULT 'en_US' NOT NULL,
    `title` VARCHAR(255),
